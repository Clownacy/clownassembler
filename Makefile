...
clownassembler_asm68k: frontend_asm68k.c dictionary.c io.c lexical.c options.c p2bin.c semantic.c shared-memory.c strcmpci.c string.c string-stack.c substitute.c syntactic.c
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) $^ -o $@ $(LIBS)

clownassembler: frontend_custom.c dictionary.c io.c lexical.c options.c p2bin.c semantic.c shared-memory.c strcmpci.c string.c string-stack.c substitute.c syntactic.c
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) $^ -o $@ $(LIBS)
