...
;	Includes new simulator graphics commands 2002/3/4/5/6/7				;
;														;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;														;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	dc.l	Group1Or2ExceptionHandler04, Group1Or2ExceptionHandler05, Group1Or2ExceptionHandler06, Group1Or2ExceptionHandler07
	dc.l	Group1Or2ExceptionHandler08, Group1Or2ExceptionHandler09, Group1Or2ExceptionHandler0A, Group1Or2ExceptionHandler0B
	dc.l	Group1Or2ExceptionHandler0C, Group1Or2ExceptionHandler0D, Group1Or2ExceptionHandler0E, Group1Or2ExceptionHandler0F

	dc.l	Group1Or2ExceptionHandler10, Group1Or2ExceptionHandler11, Group1Or2ExceptionHandler12, Group1Or2ExceptionHandler13
	dc.l	Group1Or2ExceptionHandler14, Group1Or2ExceptionHandler15, Group1Or2ExceptionHandler16, Group1Or2ExceptionHandler17
	dc.l	Group1Or2ExceptionHandler18, Group1Or2ExceptionHandler19, Group1Or2ExceptionHandler1A, Group1Or2ExceptionHandler1B
	dc.l	Group1Or2ExceptionHandler1C, Group1Or2ExceptionHandler1D, Group1Or2ExceptionHandler1E, Group1Or2ExceptionHandler1F

	dc.l	Group1Or2ExceptionHandler20, Group1Or2ExceptionHandler21, Group1Or2ExceptionHandler22, Group1Or2ExceptionHandler23
	dc.l	Group1Or2ExceptionHandler24, Group1Or2ExceptionHandler25, Group1Or2ExceptionHandler26, Group1Or2ExceptionHandler27
	dc.l	Group1Or2ExceptionHandler28, Group1Or2ExceptionHandler29, Group1Or2ExceptionHandler2A, Group1Or2ExceptionHandler2B
	dc.l	Group1Or2ExceptionHandler2C, Group1Or2ExceptionHandler2D, Group1Or2ExceptionHandler2E, Group1Or2ExceptionHandler2F

	dc.l	Group1Or2ExceptionHandler30, Group1Or2ExceptionHandler31, Group1Or2ExceptionHandler32, Group1Or2ExceptionHandler33
	dc.l	Group1Or2ExceptionHandler34, Group1Or2ExceptionHandler35, Group1Or2ExceptionHandler36, Group1Or2ExceptionHandler37
	dc.l	Group1Or2ExceptionHandler38, Group1Or2ExceptionHandler39, Group1Or2ExceptionHandler3A, Group1Or2ExceptionHandler3B
	dc.l	Group1Or2ExceptionHandler3C, Group1Or2ExceptionHandler3D, Group1Or2ExceptionHandler3E, Group1Or2ExceptionHandler3F

JumpToAddressZero:
	lea	(ram_addr+ram_base).l,sp
...
\group\ExceptionHandler\number:
	...
	MakeExceptionHandler Group0,02
	MakeExceptionHandler Group0,03
	MakeExceptionHandler Group1Or2,04
	MakeExceptionHandler Group1Or2,05
	MakeExceptionHandler Group1Or2,06
	MakeExceptionHandler Group1Or2,07
	MakeExceptionHandler Group1Or2,08
	MakeExceptionHandler Group1Or2,09
	MakeExceptionHandler Group1Or2,0A
	MakeExceptionHandler Group1Or2,0B
	MakeExceptionHandler Group1Or2,0C
	MakeExceptionHandler Group1Or2,0D
	MakeExceptionHandler Group1Or2,0E
	MakeExceptionHandler Group1Or2,0F
	MakeExceptionHandler Group1Or2,10
	MakeExceptionHandler Group1Or2,11
	MakeExceptionHandler Group1Or2,12
	MakeExceptionHandler Group1Or2,13
	MakeExceptionHandler Group1Or2,14
	MakeExceptionHandler Group1Or2,15
	MakeExceptionHandler Group1Or2,16
	MakeExceptionHandler Group1Or2,17
	MakeExceptionHandler Group1Or2,18
	MakeExceptionHandler Group1Or2,19
	MakeExceptionHandler Group1Or2,1A
	MakeExceptionHandler Group1Or2,1B
	MakeExceptionHandler Group1Or2,1C
	MakeExceptionHandler Group1Or2,1D
	MakeExceptionHandler Group1Or2,1E
	MakeExceptionHandler Group1Or2,1F
	MakeExceptionHandler Group1Or2,20
	MakeExceptionHandler Group1Or2,21
	MakeExceptionHandler Group1Or2,22
	MakeExceptionHandler Group1Or2,23
	MakeExceptionHandler Group1Or2,24
	MakeExceptionHandler Group1Or2,25
	MakeExceptionHandler Group1Or2,26
	MakeExceptionHandler Group1Or2,27
	MakeExceptionHandler Group1Or2,28
	MakeExceptionHandler Group1Or2,29
	MakeExceptionHandler Group1Or2,2A
	MakeExceptionHandler Group1Or2,2B
	MakeExceptionHandler Group1Or2,2C
	MakeExceptionHandler Group1Or2,2D
	MakeExceptionHandler Group1Or2,2E
	MakeExceptionHandler Group1Or2,2F
	MakeExceptionHandler Group1Or2,30
	MakeExceptionHandler Group1Or2,31
	MakeExceptionHandler Group1Or2,32
	MakeExceptionHandler Group1Or2,33
	MakeExceptionHandler Group1Or2,34
	MakeExceptionHandler Group1Or2,35
	MakeExceptionHandler Group1Or2,36
	MakeExceptionHandler Group1Or2,37
	MakeExceptionHandler Group1Or2,38
	MakeExceptionHandler Group1Or2,39
	MakeExceptionHandler Group1Or2,3A
	MakeExceptionHandler Group1Or2,3B
	MakeExceptionHandler Group1Or2,3C
	MakeExceptionHandler Group1Or2,3D
	MakeExceptionHandler Group1Or2,3E
	MakeExceptionHandler Group1Or2,3F

Group0ExceptionHandlerCommon:
	addq.l	#8,sp

Group1Or2ExceptionHandlerCommon:
	move.l	2(sp),d1
...
;	RTS
	...
	MOVE.B	STATUS, D0	; get serial status
	ANDI.B	#1, D0 		; mask D0 - RXF (active low)
	BEQ	RETCHR
	ANDI.B	#$FE,CCR	; clear the carry, flag we got no byte								
	RTS
...
LAB_1274
	;MOVEQ		#16,d1			; turn off double buffering
...
LAB_13FF
	MOVE.b	d0,Oquote(a3)		; save token-$3A ($00 for ":", TK_DATA-$3A for
							; DATA)
LAB_1401
	SUBI.b		#(TK_REM-$3A),d0		; subtract REM token offset
...
LAB_LOOP
	...
	SUBI.b		#TK_UNTIL,d7		; subtract token for UNTIL
...
LAB_174E
	...
	MOVEQ		#$FFFFFF00|TK_ELSE,d3			; set search for ELSE token
	MOVEQ		#$FFFFFF00|TK_IF,d4			; set search for IF token
...
LAB_1785
	...
	SUBI.b		#$30,d0			; subtract $30 from byte
...
; value at the top of this file set to zero
 ...
 if	nobrk=0
	...
	BRA		LAB_1647			; else go do BREAK exit
...
LAB_1ADB
	BSR		LAB_GBYT			; scan memory
LAB_1ADE
	SUBI.b		#TK_GT,d0			; subtract token for > (lowest compare function)
...
LAB_1AFA
	...
	ADDI.b	#(TK_GT-TK_PLUS),d0		; add # of operators (+ - ; / ^ AND OR EOR)
...
LAB_GVAL
	...
	BNE.s		LAB_1BF3			; if not open quote then it must be a variable
							; or an open bracket
...
LAB_1BE7
	...
	CMPI.b		#TK_POINT,d0		; compare with token for POINT
	BEQ		LAB_FPOINT			; if POINT go evaluate POINT(x,y)

							; wasn't +, -, NOT or FN so ...
	SUBI.b		#TK_SGN,d0			; compare with token for SGN & normalise
...
LAB_204S
	...
	BSR		LAB_EVEX			; evaluate expression
	BSR		LAB_GBYT			; scan memory
	BNE		LAB_SNER			; if not [EOL] or [EOS] do syntax error then
							; warm start
...
LAB_2045
	TST.b		Dtypef(a3)			; test data type
	BPL		LAB_2778			; if numeric pack FAC1 into variable (a0) and
							; return
...
LAB_LOAD
	JMP		V_LOAD(a3)			; do the load vector 
...
LAB_SAVE
	JMP		V_SAVE(a3)			; do the save vector
...
LAB_TI
	;MOVEQ		#8,d0				; get time
	;TRAP		#15				; do I/O function
	MOVE.l	d1,FAC1_m(a3)		; time (in 100ths seconds) into FAC1
	MOVE.w	#$A000,FAC1_e(a3)		; time exponent and sign
...
LAB_KEYS
	TST.b		Dtypef(a3)			; test data type, $80=string, $40=integer,
							; $00=float
	BMI.s		LAB_KESS			; branch if string

	BSR		LAB_EVIR			; evaluate integer expression (no sign check)
							; result in d0 and Itemp
LAB_KEZZ
	MOVE.l	d0,d1				; copy key value to parameter
LAB_KETT
...
LAB_KESS
	BSR		LAB_22B6			; pop string off descriptor stack or from memory
							; returns with d0 = length, a0 = pointer
	BEQ		LAB_KEZZ			; return last key if null string

	CMPI.w		#5,d0				; compare length with max+1
	BCS.s		LAB_KKSS			; branch if <= 4

	MOVEQ		#4,d0				; else make = 4
LAB_KKSS
	MOVEQ		#0,d1				; clear parameter
	SUBQ.w	#1,d0				; -1 for BF loop
LAB_KSSS
	ASL.l		#8,d1				; shift any previous characters along
	MOVE.b	(a0)+,d1			; get byte from string
	DBF		d0,LAB_KSSS			; decrement count and loop if not done yet

	BRA.s		LAB_KETT			; go test the keys
...
LAB_MODE
	BSR		LAB_GTBY			; get byte parameter, result in d0 and Itemp
	CMPI.b		#$12,d0			; compare with max+1
...
LAB_CURSOR
	BSR		LAB_GTBY			; get byte parameter, result in d0 and Itemp
	CMPI.b		#80,d0			; compare with max+1
	...
	CMPI.b		#32,d0			; compare with max+1
...
LAB_LOG
	...
	SUBI.l		#$81,d7			; normalise exponent
	...
	SUBI.b		#$82,d1			; normalise and two integer bits
...
;			product =		mmmm  mmmm
	...
	ADDI.L		#$8000,d1			; round up lowest word
...
LAB_MUF1
	...
	ADDI.l		#$10000,d3			; else correct result
LAB_MUF2
	ADDI.l		#$8000,d1			; round up low word
...
LAB_DIVIDE
	...
	ADDI.w		#$80,d0			; correct 16 bit exponent result
...
LAB_2831
	...
	MOVE.l	d1,-(sp)			; save d1
	MOVEQ		#$FFFFFFA0,d1			; set for no floating bits
...
LAB_284H
	MOVE.l	(sp)+,d1			; restore d1
LAB_284J
	MOVE.l	d0,Itemp(a3)		; save the result
	RTS
...
LAB_INT
	MOVEQ		#$FFFFFFA0,d0			; set for no floating bits
	SUB.b		FAC1_e(a3),d0		; subtract FAC1 exponent
...
LAB_2969
	ADDI.b		#'0',d0			; make last character
...
LAB_29C3
	...
	ADDI.b		#8,d0				; allow 7 digits before point
...
LAB_2A1A
	...
	ADDI.b		#$0B,d0			; and subtract from 11 decimal
LAB_2A21
	ADDI.b		#$2F,d0			; add "0"-1 to result
...
LAB_2A74
	...
	SUBI.b		#$0A,d2			; subtract 10 from exponent count
	BCC.s		LAB_2A74			; loop while still >= 0

	ADDI.b		#$3A,d2			; add character ":", $30+$0A, result is 10-value
...
LAB_ESML
	...
	MOVE.l	FAC1_m(a3),d0		; get mantissa
	MOVE.b	FAC1_e(a3),d5		; get exponent
	SUBI.w		#$82,d5			; normalise and -2 (result is -1 to -30)
	NEG.w		d5				; make +ve
...
LAB_SIN
	...
	SUBI.b		#$80,d0			; normalise exponent
...
LAB_ATLE
	MOVE.l	FAC1_m(a3),d0		; get FAC1 mantissa
	MOVEQ		#$FFFFFF82,d1			; set to correct exponent
...
LAB_U002
	...
	SUBI.w		#$100,d0			; effectively divide the mantissa by 2
...
EndBHS
	...
	NEG.l		d1				; make -ve
	ADDI.l		#BHsend,d1			; effectively (end-length)
...
TK_LIST		EQU TK_SIZE+1		; $AD
TK_CLEAR		EQU TK_LIST+1		; $AE
TK_NEW		EQU TK_CLEAR+1		; $AF
TK_WIDTH		EQU TK_NEW+1		; $B0
TK_GET		EQU TK_WIDTH+1		; $B1
TK_SWAP		EQU TK_GET+1		; $B2
TK_BITSET		EQU TK_SWAP+1		; $B3
TK_BITCLR		EQU TK_BITSET+1		; $B4
TK_TAB		EQU TK_BITCLR+1		; $B5
TK_ELSE		EQU TK_TAB+1		; $B6
TK_TO			EQU TK_ELSE+1		; $B7
TK_FN			EQU TK_TO+1			; $B8
TK_SPC		EQU TK_FN+1			; $B9
TK_THEN		EQU TK_SPC+1		; $BA
TK_NOT		EQU TK_THEN+1		; $BB
TK_STEP		EQU TK_NOT+1		; $BC
TK_UNTIL		EQU TK_STEP+1		; $BD
TK_WHILE		EQU TK_UNTIL+1		; $BE
TK_PLUS		EQU TK_WHILE+1		; $BF
TK_MINUS		EQU TK_PLUS+1		; $C0
TK_MULT		EQU TK_MINUS+1		; $C1
TK_DIV		EQU TK_MULT+1		; $C2
TK_POWER		EQU TK_DIV+1		; $C3
TK_AND		EQU TK_POWER+1		; $C4
TK_EOR		EQU TK_AND+1		; $C5
TK_OR			EQU TK_EOR+1		; $C6
TK_RSHIFT		EQU TK_OR+1			; $C7
TK_LSHIFT		EQU TK_RSHIFT+1		; $C8
TK_GT			EQU TK_LSHIFT+1		; $C9
TK_EQUAL		EQU TK_GT+1			; $CA
TK_LT			EQU TK_EQUAL+1		; $CB
TK_SGN		EQU TK_LT+1			; $CC
TK_INT		EQU TK_SGN+1		; $CD
TK_ABS		EQU TK_INT+1		; $CE
TK_USR		EQU TK_ABS+1		; $CF
TK_FRE		EQU TK_USR+1		; $D0
TK_POS		EQU TK_FRE+1		; $D1
TK_SQR		EQU TK_POS+1		; $D2
TK_RND		EQU TK_SQR+1		; $D3
TK_LOG		EQU TK_RND+1		; $D4
TK_EXP		EQU TK_LOG+1		; $D5
TK_COS		EQU TK_EXP+1		; $D6
TK_SIN		EQU TK_COS+1		; $D7
TK_TAN		EQU TK_SIN+1		; $D8
TK_ATN		EQU TK_TAN+1		; $D9
TK_PEEK		EQU TK_ATN+1		; $DA
TK_DEEK		EQU TK_PEEK+1		; $DB
TK_LEEK		EQU TK_DEEK+1		; $DC
TK_LEN		EQU TK_LEEK+1		; $DD
TK_STRS		EQU TK_LEN+1		; $DE
TK_VAL		EQU TK_STRS+1		; $DF
TK_ASC		EQU TK_VAL+1		; $E0
TK_UCASES		EQU TK_ASC+1		; $E1
TK_LCASES		EQU TK_UCASES+1		; $E2
TK_CHRS		EQU TK_LCASES+1		; $E3
TK_HEXS		EQU TK_CHRS+1		; $E4
TK_BINS		EQU TK_HEXS+1		; $E5
TK_BITTST		EQU TK_BINS+1		; $E6
TK_MAX		EQU TK_BITTST+1		; $E7
TK_MIN		EQU TK_MAX+1		; $E8
TK_RAM		EQU TK_MIN+1		; $E9
TK_KEYS		EQU TK_RAM+1		; $EA EASy68k simulator extension
TK_TI			EQU TK_KEYS+1		; $EB EASy68k simulator extension
TK_PI			EQU TK_TI+1			; $EC
TK_TWOPI		EQU TK_PI+1			; $ED
TK_VPTR		EQU TK_TWOPI+1		; $EE
TK_SADD		EQU TK_VPTR+1		; $EF
TK_LEFTS		EQU TK_SADD+1		; $F0
TK_RIGHTS		EQU TK_LEFTS+1		; $F1
TK_MIDS		EQU TK_RIGHTS+1		; $F2
TK_USINGS		EQU TK_MIDS+1		; $F3
...
LAB_SMSG
	...
	dc.b	'Enhanced 68k BASIC Version 3.52',$0D,$0A
	dc.b	'for the Sim68k 68000 simulator',$0D,$0A
	dc.b	'Extension commands Version 2.33',$0D,$0A,$00
