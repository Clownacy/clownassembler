...
#define String_CreateCopy(OUTPUT, INPUT) String_Create(OUTPUT, (INPUT)->buffer, (INPUT)->length)
#define String_CreateAppend(OUTPUT, INPUT_1, INPUT_2) String_CreateInternal(OUTPUT, (INPUT_1)->buffer, (INPUT_1)->length, (INPUT_2)->buffer, (INPUT_2)->length)
void String_Destroy(String *string);

cc_bool String_Compare(const String *string, const String *other_string);
#define String_Data(STRING) (STRING)->buffer
