...
# define M68KASM_TOKENTYPE
  enum m68kasm_tokentype
  {
    ...
    TOKEN_DIRECTIVE_DS = 377,      /* TOKEN_DIRECTIVE_DS  */
    TOKEN_DIRECTIVE_REPT = 378,    /* TOKEN_DIRECTIVE_REPT  */
    TOKEN_DIRECTIVE_ENDR = 379,    /* TOKEN_DIRECTIVE_ENDR  */
    TOKEN_DIRECTIVE_MACRO = 380,   /* TOKEN_DIRECTIVE_MACRO  */
    TOKEN_DIRECTIVE_MACROS = 381,  /* TOKEN_DIRECTIVE_MACROS  */
    TOKEN_DIRECTIVE_ENDM = 382,    /* TOKEN_DIRECTIVE_ENDM  */
    TOKEN_DIRECTIVE_INCLUDE = 383, /* TOKEN_DIRECTIVE_INCLUDE  */
    TOKEN_DIRECTIVE_INCBIN = 384,  /* TOKEN_DIRECTIVE_INCBIN  */
    TOKEN_DIRECTIVE_EQU = 385,     /* TOKEN_DIRECTIVE_EQU  */
    TOKEN_DIRECTIVE_EQUR = 386,    /* TOKEN_DIRECTIVE_EQUR  */
    ...
    TOKEN_DIRECTIVE_IFEQ = 391,    /* TOKEN_DIRECTIVE_IFEQ  */
    TOKEN_DIRECTIVE_IFNE = 392,    /* TOKEN_DIRECTIVE_IFNE  */
    TOKEN_DIRECTIVE_IFGT = 393,    /* TOKEN_DIRECTIVE_IFGT  */
    TOKEN_DIRECTIVE_IFLT = 394,    /* TOKEN_DIRECTIVE_IFLT  */
    TOKEN_DIRECTIVE_IFGE = 395,    /* TOKEN_DIRECTIVE_IFGE  */
    TOKEN_DIRECTIVE_IFLE = 396,    /* TOKEN_DIRECTIVE_IFLE  */
    TOKEN_DIRECTIVE_ELSEIF = 397,  /* TOKEN_DIRECTIVE_ELSEIF  */
    TOKEN_DIRECTIVE_ELSE = 398,    /* TOKEN_DIRECTIVE_ELSE  */
    TOKEN_DIRECTIVE_ENDC = 399,    /* TOKEN_DIRECTIVE_ENDC  */
    TOKEN_DIRECTIVE_WHILE = 400,   /* TOKEN_DIRECTIVE_WHILE  */
    TOKEN_DIRECTIVE_ENDW = 401,    /* TOKEN_DIRECTIVE_ENDW  */
    TOKEN_DIRECTIVE_EVEN = 402,    /* TOKEN_DIRECTIVE_EVEN  */
    TOKEN_DIRECTIVE_CNOP = 403,    /* TOKEN_DIRECTIVE_CNOP  */
    TOKEN_DIRECTIVE_INFORM = 404,  /* TOKEN_DIRECTIVE_INFORM  */
    TOKEN_DIRECTIVE_FAIL = 405,    /* TOKEN_DIRECTIVE_FAIL  */
    TOKEN_DIRECTIVE_END = 406,     /* TOKEN_DIRECTIVE_END  */
    TOKEN_DIRECTIVE_RS = 407,      /* TOKEN_DIRECTIVE_RS  */
    TOKEN_DIRECTIVE_RSSET = 408,   /* TOKEN_DIRECTIVE_RSSET  */
    TOKEN_DIRECTIVE_RSRESET = 409, /* TOKEN_DIRECTIVE_RSRESET  */
    TOKEN_DIRECTIVE_OBJ = 410,     /* TOKEN_DIRECTIVE_OBJ  */
    TOKEN_DIRECTIVE_OBJEND = 411,  /* TOKEN_DIRECTIVE_OBJEND  */
    TOKEN_DIRECTIVE_ORG = 412,     /* TOKEN_DIRECTIVE_ORG  */
    TOKEN_DIRECTIVE_PUSHO = 413,   /* TOKEN_DIRECTIVE_PUSHO  */
    TOKEN_DIRECTIVE_POPO = 414,    /* TOKEN_DIRECTIVE_POPO  */
    TOKEN_DIRECTIVE_OPT = 415,     /* TOKEN_DIRECTIVE_OPT  */
    TOKEN_DIRECTIVE_PUSHP = 416,   /* TOKEN_DIRECTIVE_PUSHP  */
    TOKEN_DIRECTIVE_POPP = 417,    /* TOKEN_DIRECTIVE_POPP  */
    TOKEN_DIRECTIVE_SHIFT = 418,   /* TOKEN_DIRECTIVE_SHIFT  */
    TOKEN_DIRECTIVE_MEXIT = 419,   /* TOKEN_DIRECTIVE_MEXIT  */
    TOKEN_DIRECTIVE_LOCAL = 420,   /* TOKEN_DIRECTIVE_LOCAL  */
    TOKEN_DIRECTIVE_LIST = 421,    /* TOKEN_DIRECTIVE_LIST  */
    TOKEN_DIRECTIVE_NOLIST = 422,  /* TOKEN_DIRECTIVE_NOLIST  */
    TOKEN_DIRECTIVE_PURGE = 423,   /* TOKEN_DIRECTIVE_PURGE  */
    TOKEN_SIZE_BYTE = 424,         /* TOKEN_SIZE_BYTE  */
    TOKEN_SIZE_SHORT = 425,        /* TOKEN_SIZE_SHORT  */
    TOKEN_SIZE_WORD = 426,         /* TOKEN_SIZE_WORD  */
    TOKEN_SIZE_LONGWORD = 427,     /* TOKEN_SIZE_LONGWORD  */
    TOKEN_DATA_REGISTER = 428,     /* TOKEN_DATA_REGISTER  */
    TOKEN_ADDRESS_REGISTER = 429,  /* TOKEN_ADDRESS_REGISTER  */
    TOKEN_NUMBER = 430,            /* TOKEN_NUMBER  */
    TOKEN_IDENTIFIER = 431,        /* TOKEN_IDENTIFIER  */
    TOKEN_LOCAL_IDENTIFIER = 432,  /* TOKEN_LOCAL_IDENTIFIER  */
    TOKEN_STRING = 433,            /* TOKEN_STRING  */
    TOKEN_OPTION = 434,            /* TOKEN_OPTION  */
    TOKEN_STATUS_REGISTER = 435,   /* TOKEN_STATUS_REGISTER  */
    TOKEN_CONDITION_CODE_REGISTER = 436, /* TOKEN_CONDITION_CODE_REGISTER  */
    TOKEN_USER_STACK_POINTER_REGISTER = 437, /* TOKEN_USER_STACK_POINTER_REGISTER  */
    TOKEN_PROGRAM_COUNTER = 438,   /* TOKEN_PROGRAM_COUNTER  */
    TOKEN_LOGICAL_AND = 439,       /* TOKEN_LOGICAL_AND  */
    TOKEN_LOGICAL_OR = 440,        /* TOKEN_LOGICAL_OR  */
    TOKEN_EQUALITY = 441,          /* TOKEN_EQUALITY  */
    TOKEN_INEQUALITY = 442,        /* TOKEN_INEQUALITY  */
    TOKEN_LESS_OR_EQUAL = 443,     /* TOKEN_LESS_OR_EQUAL  */
    TOKEN_MORE_OR_EQUAL = 444,     /* TOKEN_MORE_OR_EQUAL  */
    TOKEN_LEFT_SHIFT = 445,        /* TOKEN_LEFT_SHIFT  */
    TOKEN_RIGHT_SHIFT = 446,       /* TOKEN_RIGHT_SHIFT  */
    TOKEN_STRLEN = 447,            /* TOKEN_STRLEN  */
    TOKEN_STRCMP = 448,            /* TOKEN_STRCMP  */
    TOKEN_INSTR = 449,             /* TOKEN_INSTR  */
    TOKEN_DEF = 450,               /* TOKEN_DEF  */
    TOKEN_TYPE = 451,              /* TOKEN_TYPE  */
    TOKEN_FILESIZE = 452,          /* TOKEN_FILESIZE  */
    TOKEN_OFFSET = 453             /* TOKEN_OFFSET  */
  };
