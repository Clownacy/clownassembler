...
# define M68KASM_TOKENTYPE
  enum m68kasm_tokentype
  {
    ...
    TOKEN_DIRECTIVE_EQUS = 385,    /* TOKEN_DIRECTIVE_EQUS  */
    TOKEN_DIRECTIVE_SUBSTR = 386,  /* TOKEN_DIRECTIVE_SUBSTR  */
    TOKEN_DIRECTIVE_SET = 387,     /* TOKEN_DIRECTIVE_SET  */
    TOKEN_DIRECTIVE_IF = 388,      /* TOKEN_DIRECTIVE_IF  */
    TOKEN_DIRECTIVE_ELSEIF = 389,  /* TOKEN_DIRECTIVE_ELSEIF  */
    TOKEN_DIRECTIVE_ELSE = 390,    /* TOKEN_DIRECTIVE_ELSE  */
    TOKEN_DIRECTIVE_ENDC = 391,    /* TOKEN_DIRECTIVE_ENDC  */
    TOKEN_DIRECTIVE_WHILE = 392,   /* TOKEN_DIRECTIVE_WHILE  */
    TOKEN_DIRECTIVE_ENDW = 393,    /* TOKEN_DIRECTIVE_ENDW  */
    TOKEN_DIRECTIVE_EVEN = 394,    /* TOKEN_DIRECTIVE_EVEN  */
    TOKEN_DIRECTIVE_CNOP = 395,    /* TOKEN_DIRECTIVE_CNOP  */
    TOKEN_DIRECTIVE_INFORM = 396,  /* TOKEN_DIRECTIVE_INFORM  */
    TOKEN_DIRECTIVE_FAIL = 397,    /* TOKEN_DIRECTIVE_FAIL  */
    TOKEN_DIRECTIVE_END = 398,     /* TOKEN_DIRECTIVE_END  */
    TOKEN_DIRECTIVE_RS = 399,      /* TOKEN_DIRECTIVE_RS  */
    TOKEN_DIRECTIVE_RSSET = 400,   /* TOKEN_DIRECTIVE_RSSET  */
    TOKEN_DIRECTIVE_RSRESET = 401, /* TOKEN_DIRECTIVE_RSRESET  */
    TOKEN_DIRECTIVE_OBJ = 402,     /* TOKEN_DIRECTIVE_OBJ  */
    TOKEN_DIRECTIVE_OBJEND = 403,  /* TOKEN_DIRECTIVE_OBJEND  */
    TOKEN_DIRECTIVE_ORG = 404,     /* TOKEN_DIRECTIVE_ORG  */
    TOKEN_DIRECTIVE_PUSHO = 405,   /* TOKEN_DIRECTIVE_PUSHO  */
    TOKEN_DIRECTIVE_POPO = 406,    /* TOKEN_DIRECTIVE_POPO  */
    TOKEN_DIRECTIVE_OPT = 407,     /* TOKEN_DIRECTIVE_OPT  */
    TOKEN_DIRECTIVE_PUSHP = 408,   /* TOKEN_DIRECTIVE_PUSHP  */
    ...
    TOKEN_DIRECTIVE_LIST = 413,    /* TOKEN_DIRECTIVE_LIST  */
    TOKEN_DIRECTIVE_NOLIST = 414,  /* TOKEN_DIRECTIVE_NOLIST  */
    TOKEN_SIZE_BYTE = 415,         /* TOKEN_SIZE_BYTE  */
    TOKEN_SIZE_SHORT = 416,        /* TOKEN_SIZE_SHORT  */
    TOKEN_SIZE_WORD = 417,         /* TOKEN_SIZE_WORD  */
    TOKEN_SIZE_LONGWORD = 418,     /* TOKEN_SIZE_LONGWORD  */
    TOKEN_DATA_REGISTER = 419,     /* TOKEN_DATA_REGISTER  */
    TOKEN_ADDRESS_REGISTER = 420,  /* TOKEN_ADDRESS_REGISTER  */
    TOKEN_NUMBER = 421,            /* TOKEN_NUMBER  */
    TOKEN_IDENTIFIER = 422,        /* TOKEN_IDENTIFIER  */
    TOKEN_LOCAL_IDENTIFIER = 423,  /* TOKEN_LOCAL_IDENTIFIER  */
    TOKEN_STRING = 424,            /* TOKEN_STRING  */
    TOKEN_OPTION = 425,            /* TOKEN_OPTION  */
    TOKEN_STATUS_REGISTER = 426,   /* TOKEN_STATUS_REGISTER  */
    TOKEN_CONDITION_CODE_REGISTER = 427, /* TOKEN_CONDITION_CODE_REGISTER  */
    TOKEN_USER_STACK_POINTER_REGISTER = 428, /* TOKEN_USER_STACK_POINTER_REGISTER  */
    TOKEN_PROGRAM_COUNTER = 429,   /* TOKEN_PROGRAM_COUNTER  */
    TOKEN_LOGICAL_AND = 430,       /* TOKEN_LOGICAL_AND  */
    TOKEN_LOGICAL_OR = 431,        /* TOKEN_LOGICAL_OR  */
    TOKEN_EQUALITY = 432,          /* TOKEN_EQUALITY  */
    TOKEN_INEQUALITY = 433,        /* TOKEN_INEQUALITY  */
    TOKEN_LESS_OR_EQUAL = 434,     /* TOKEN_LESS_OR_EQUAL  */
    TOKEN_MORE_OR_EQUAL = 435,     /* TOKEN_MORE_OR_EQUAL  */
    TOKEN_LEFT_SHIFT = 436,        /* TOKEN_LEFT_SHIFT  */
    TOKEN_RIGHT_SHIFT = 437,       /* TOKEN_RIGHT_SHIFT  */
    TOKEN_STRLEN = 438,            /* TOKEN_STRLEN  */
    TOKEN_STRCMP = 439,            /* TOKEN_STRCMP  */
