...
# define M68KASM_TOKENTYPE
  enum m68kasm_tokentype
  {
    ...
    TOKEN_DIRECTIVE_SET = 386,     /* TOKEN_DIRECTIVE_SET  */
    TOKEN_DIRECTIVE_IF = 387,      /* TOKEN_DIRECTIVE_IF  */
    TOKEN_DIRECTIVE_ELSEIF = 388,  /* TOKEN_DIRECTIVE_ELSEIF  */
    TOKEN_DIRECTIVE_ELSE = 389,    /* TOKEN_DIRECTIVE_ELSE  */
    TOKEN_DIRECTIVE_ENDC = 390,    /* TOKEN_DIRECTIVE_ENDC  */
    TOKEN_DIRECTIVE_WHILE = 391,   /* TOKEN_DIRECTIVE_WHILE  */
    TOKEN_DIRECTIVE_ENDW = 392,    /* TOKEN_DIRECTIVE_ENDW  */
    TOKEN_DIRECTIVE_EVEN = 393,    /* TOKEN_DIRECTIVE_EVEN  */
    TOKEN_DIRECTIVE_CNOP = 394,    /* TOKEN_DIRECTIVE_CNOP  */
    TOKEN_DIRECTIVE_INFORM = 395,  /* TOKEN_DIRECTIVE_INFORM  */
    TOKEN_DIRECTIVE_FAIL = 396,    /* TOKEN_DIRECTIVE_FAIL  */
    TOKEN_DIRECTIVE_END = 397,     /* TOKEN_DIRECTIVE_END  */
    TOKEN_DIRECTIVE_RS = 398,      /* TOKEN_DIRECTIVE_RS  */
    TOKEN_DIRECTIVE_RSSET = 399,   /* TOKEN_DIRECTIVE_RSSET  */
    TOKEN_DIRECTIVE_RSRESET = 400, /* TOKEN_DIRECTIVE_RSRESET  */
    TOKEN_DIRECTIVE_OBJ = 401,     /* TOKEN_DIRECTIVE_OBJ  */
    TOKEN_DIRECTIVE_OBJEND = 402,  /* TOKEN_DIRECTIVE_OBJEND  */
    TOKEN_DIRECTIVE_ORG = 403,     /* TOKEN_DIRECTIVE_ORG  */
    TOKEN_SIZE_BYTE = 404,         /* TOKEN_SIZE_BYTE  */
    TOKEN_SIZE_SHORT = 405,        /* TOKEN_SIZE_SHORT  */
    TOKEN_SIZE_WORD = 406,         /* TOKEN_SIZE_WORD  */
    TOKEN_SIZE_LONGWORD = 407,     /* TOKEN_SIZE_LONGWORD  */
    TOKEN_DATA_REGISTER = 408,     /* TOKEN_DATA_REGISTER  */
    TOKEN_ADDRESS_REGISTER = 409,  /* TOKEN_ADDRESS_REGISTER  */
    TOKEN_NUMBER = 410,            /* TOKEN_NUMBER  */
    TOKEN_IDENTIFIER = 411,        /* TOKEN_IDENTIFIER  */
    TOKEN_LOCAL_IDENTIFIER = 412,  /* TOKEN_LOCAL_IDENTIFIER  */
    TOKEN_STRING = 413,            /* TOKEN_STRING  */
    TOKEN_STATUS_REGISTER = 414,   /* TOKEN_STATUS_REGISTER  */
    TOKEN_CONDITION_CODE_REGISTER = 415, /* TOKEN_CONDITION_CODE_REGISTER  */
    TOKEN_USER_STACK_POINTER_REGISTER = 416, /* TOKEN_USER_STACK_POINTER_REGISTER  */
    TOKEN_PROGRAM_COUNTER = 417,   /* TOKEN_PROGRAM_COUNTER  */
    TOKEN_LOGICAL_AND = 418,       /* TOKEN_LOGICAL_AND  */
    TOKEN_LOGICAL_OR = 419,        /* TOKEN_LOGICAL_OR  */
    TOKEN_EQUALITY = 420,          /* TOKEN_EQUALITY  */
    TOKEN_INEQUALITY = 421,        /* TOKEN_INEQUALITY  */
    TOKEN_LESS_OR_EQUAL = 422,     /* TOKEN_LESS_OR_EQUAL  */
    TOKEN_MORE_OR_EQUAL = 423,     /* TOKEN_MORE_OR_EQUAL  */
    TOKEN_LEFT_SHIFT = 424,        /* TOKEN_LEFT_SHIFT  */
    TOKEN_RIGHT_SHIFT = 425,       /* TOKEN_RIGHT_SHIFT  */
    TOKEN_STRLEN = 426,            /* TOKEN_STRLEN  */
    TOKEN_STRCMP = 427,            /* TOKEN_STRCMP  */
    TOKEN_DEF = 428                /* TOKEN_DEF  */
  };
