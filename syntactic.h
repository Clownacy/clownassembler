...
# define M68KASM_TOKENTYPE
  enum m68kasm_tokentype
  {
    ...
    TOKEN_DIRECTIVE_EQUS = 386,    /* TOKEN_DIRECTIVE_EQUS  */
    TOKEN_DIRECTIVE_SUBSTR = 387,  /* TOKEN_DIRECTIVE_SUBSTR  */
    TOKEN_DIRECTIVE_SET = 388,     /* TOKEN_DIRECTIVE_SET  */
    TOKEN_DIRECTIVE_IF = 389,      /* TOKEN_DIRECTIVE_IF  */
    TOKEN_DIRECTIVE_ELSEIF = 390,  /* TOKEN_DIRECTIVE_ELSEIF  */
    TOKEN_DIRECTIVE_ELSE = 391,    /* TOKEN_DIRECTIVE_ELSE  */
    TOKEN_DIRECTIVE_ENDC = 392,    /* TOKEN_DIRECTIVE_ENDC  */
    TOKEN_DIRECTIVE_WHILE = 393,   /* TOKEN_DIRECTIVE_WHILE  */
    TOKEN_DIRECTIVE_ENDW = 394,    /* TOKEN_DIRECTIVE_ENDW  */
    TOKEN_DIRECTIVE_EVEN = 395,    /* TOKEN_DIRECTIVE_EVEN  */
    TOKEN_DIRECTIVE_CNOP = 396,    /* TOKEN_DIRECTIVE_CNOP  */
    TOKEN_DIRECTIVE_INFORM = 397,  /* TOKEN_DIRECTIVE_INFORM  */
    TOKEN_DIRECTIVE_FAIL = 398,    /* TOKEN_DIRECTIVE_FAIL  */
    TOKEN_DIRECTIVE_END = 399,     /* TOKEN_DIRECTIVE_END  */
    TOKEN_DIRECTIVE_RS = 400,      /* TOKEN_DIRECTIVE_RS  */
    TOKEN_DIRECTIVE_RSSET = 401,   /* TOKEN_DIRECTIVE_RSSET  */
    TOKEN_DIRECTIVE_RSRESET = 402, /* TOKEN_DIRECTIVE_RSRESET  */
    TOKEN_DIRECTIVE_OBJ = 403,     /* TOKEN_DIRECTIVE_OBJ  */
    TOKEN_DIRECTIVE_OBJEND = 404,  /* TOKEN_DIRECTIVE_OBJEND  */
    TOKEN_DIRECTIVE_ORG = 405,     /* TOKEN_DIRECTIVE_ORG  */
    TOKEN_DIRECTIVE_PUSHO = 406,   /* TOKEN_DIRECTIVE_PUSHO  */
    TOKEN_DIRECTIVE_POPO = 407,    /* TOKEN_DIRECTIVE_POPO  */
    TOKEN_DIRECTIVE_OPT = 408,     /* TOKEN_DIRECTIVE_OPT  */
    TOKEN_DIRECTIVE_PUSHP = 409,   /* TOKEN_DIRECTIVE_PUSHP  */
    TOKEN_DIRECTIVE_POPP = 410,    /* TOKEN_DIRECTIVE_POPP  */
    TOKEN_DIRECTIVE_SHIFT = 411,   /* TOKEN_DIRECTIVE_SHIFT  */
    TOKEN_DIRECTIVE_MEXIT = 412,   /* TOKEN_DIRECTIVE_MEXIT  */
    TOKEN_DIRECTIVE_LOCAL = 413,   /* TOKEN_DIRECTIVE_LOCAL  */
    TOKEN_DIRECTIVE_LIST = 414,    /* TOKEN_DIRECTIVE_LIST  */
    TOKEN_DIRECTIVE_NOLIST = 415,  /* TOKEN_DIRECTIVE_NOLIST  */
    TOKEN_DIRECTIVE_PURGE = 416,   /* TOKEN_DIRECTIVE_PURGE  */
    TOKEN_SIZE_BYTE = 417,         /* TOKEN_SIZE_BYTE  */
    TOKEN_SIZE_SHORT = 418,        /* TOKEN_SIZE_SHORT  */
    TOKEN_SIZE_WORD = 419,         /* TOKEN_SIZE_WORD  */
    TOKEN_SIZE_LONGWORD = 420,     /* TOKEN_SIZE_LONGWORD  */
    TOKEN_DATA_REGISTER = 421,     /* TOKEN_DATA_REGISTER  */
    TOKEN_ADDRESS_REGISTER = 422,  /* TOKEN_ADDRESS_REGISTER  */
    TOKEN_NUMBER = 423,            /* TOKEN_NUMBER  */
    TOKEN_IDENTIFIER = 424,        /* TOKEN_IDENTIFIER  */
    TOKEN_LOCAL_IDENTIFIER = 425,  /* TOKEN_LOCAL_IDENTIFIER  */
    TOKEN_STRING = 426,            /* TOKEN_STRING  */
    TOKEN_OPTION = 427,            /* TOKEN_OPTION  */
    TOKEN_STATUS_REGISTER = 428,   /* TOKEN_STATUS_REGISTER  */
    TOKEN_CONDITION_CODE_REGISTER = 429, /* TOKEN_CONDITION_CODE_REGISTER  */
    TOKEN_USER_STACK_POINTER_REGISTER = 430, /* TOKEN_USER_STACK_POINTER_REGISTER  */
    TOKEN_PROGRAM_COUNTER = 431,   /* TOKEN_PROGRAM_COUNTER  */
    TOKEN_LOGICAL_AND = 432,       /* TOKEN_LOGICAL_AND  */
    TOKEN_LOGICAL_OR = 433,        /* TOKEN_LOGICAL_OR  */
    TOKEN_EQUALITY = 434,          /* TOKEN_EQUALITY  */
    TOKEN_INEQUALITY = 435,        /* TOKEN_INEQUALITY  */
    TOKEN_LESS_OR_EQUAL = 436,     /* TOKEN_LESS_OR_EQUAL  */
    TOKEN_MORE_OR_EQUAL = 437,     /* TOKEN_MORE_OR_EQUAL  */
    TOKEN_LEFT_SHIFT = 438,        /* TOKEN_LEFT_SHIFT  */
    TOKEN_RIGHT_SHIFT = 439,       /* TOKEN_RIGHT_SHIFT  */
    TOKEN_STRLEN = 440,            /* TOKEN_STRLEN  */
    TOKEN_STRCMP = 441,            /* TOKEN_STRCMP  */
    TOKEN_INSTR = 442,             /* TOKEN_INSTR  */
    TOKEN_DEF = 443,               /* TOKEN_DEF  */
    TOKEN_TYPE = 444,              /* TOKEN_TYPE  */
    TOKEN_FILESIZE = 445,          /* TOKEN_FILESIZE  */
    TOKEN_OFFSET = 446,            /* TOKEN_OFFSET  */
    TOKEN_LOWER_PRECEDENCE_THAN_SIZE = 447, /* TOKEN_LOWER_PRECEDENCE_THAN_SIZE  */
    TOKEN_HIGHER_PRECEDENCE_THAN_SIZE = 448 /* TOKEN_HIGHER_PRECEDENCE_THAN_SIZE  */
  };
